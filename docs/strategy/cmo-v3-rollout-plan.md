...
- [ ] **Städa Stryker-artefakter** före commit (ska inte ligga i repo):
...
- [ ] Kontrollera att **inga secrets** (.env, tokens) ingår i diff
...
- [ ] CMO runner grön  
- [ ] Staging-smoke grön (eller dokumenterat env-krav)  
...
- [ ] Runbook + implementationsplan refererar denna rollout-plan  
- [ ] Ingen Stryker-instrumenterad källkod kvar i `src/`
...
5. [ ] Upprepa O2 steg 1–4 i **prod** (under underhållsfönster)  
...
| Q5 | Admin UI | Connectors-flik: status, senaste fetch, manuell refresh |

...
| — | FÖRSLAG \| Journal TP | *(utkast — migrera ej)* | — |
| — | Copy - Hälsodeklaration | *(dubblett — migrera ej)* | — |
...
| **16388** | Journal \| Ögonlocksplastik | Personal | `bleph_treatment` *(ny i Arcana)* |
...
Botox, Filler, PRP, Microneedling, Profhilo, Chemical Peeling, CO2-laser, Plasma Pen, Fat dissolving — *(ev. ej alla i bruk)*
...
| `prp-hair` | 7112 | *(Cliento TBD)* |
| `fue` / `dhi` / `beard` / `eyebrow` | 7092+ | *(Cliento TBD)* |
| `microneedling` | 7121 | *(Cliento TBD)* |
...
10. 🔲 SMS/e-post/journal-malltexter som separata filer

*Senast verifierad live: 2026-05-20.*

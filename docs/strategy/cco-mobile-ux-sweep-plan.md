...
- [x] iPhone 13 (390×844) och Android Chrome: alla primära personalflöden utan zoom/pinch _(Android + Fas 5.6 manuellt)_
- [x] Ingen primär touch target under **44×44px** _(B4 deployad prod `c98ea1b`)_
...
- [x] `npm ci && npm test` grön _(UX sweep + rollout; en legacy Cliento-test kan ge 503 lokalt)_
...
- [x] Ta bild ≤2 tap; bild ≤10s _(Playwright prod smoke 2026-05-24)_
- [x] Tabs ≥40px
...
- [x] Inputs ≥16px
- [x] `prefers-reduced-motion` OK _(ej manuellt verifierat)_

### Regression

- [x] Desktop 1280 oförändrat
- [x] `npm test` grön _(rollout-sweep 2026-05-24)_
- [x] `run:rollout-sweep` grön — 2026-05-24
- [x] `verify-staff-ui-prod` grön — 2026-05-24

### Enhet _(manuellt kvar)_

- [x] iPhone Safari 390×844 _(Fas 5.6)_
- [x] Android Chrome
- [x] PWA Add to Home Screen från `/staff`
- [x] Notch/home indicator — inget klippt

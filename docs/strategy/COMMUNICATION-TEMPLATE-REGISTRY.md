...
> **Kundresa 2026-06-03:** [`CCO-KUNDRESA-9-STEG-HAIR-TP-2026-06-03.md`](./CCO-KUNDRESA-9-STEG-HAIR-TP-2026-06-03.md). Rader med **T-48h** för friskförsäkran eller **pre-info som eget utskick** är **ogiltiga** som execution — friskförsäkran = operationsdagen (steg 8); pre-info ingår bokningsbekräftelse (steg 2).

...
| 6 | **Ingen automatisk journalföring:** Arcana ska aldrig automatiskt skapa journalpost | Kritisk | ✅ Inget journal-API |
| 7 | **Patientchatt-disclaimer:** varje chatt-session ska visa att detta inte är medicinsk rådgivning | Hög | ⚠️ Policy floor finns, explicit disclaimer i UI behövs |

 ...
 *
 * För raster-PNG: npm run shots:v11rail:block7 (kräver chromium).
 * Kör: node ./scripts/gen-v11-rail-block7-preview.mjs
 */
...
const page =
  ...
  '<title>V11 Rail · Block 7 · D + A + V + B + C + E + F — viewport-preview</title>' +
  ...
  '<h1>V11 Rail · Fas 3 · Block 7 — F Customer Journey (visuell stepper)</h1>' +
  ...
  'viewport så @media (canon §4) resolvar per bredd. Raster-PNG: <code>npm run shots:v11rail:block7</code>.</p>' +
  '<div class="row">' +
  frames +
  '</div></body></html>';

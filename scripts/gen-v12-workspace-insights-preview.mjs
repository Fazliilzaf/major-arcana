/**
 * V12 Customer Workspace · Block 6 — browserlös render av Insikter & nästa
 * åtgärd-modulen i två-zon-shellen i tre iframes (390 / 820 / 1440).
 *
 * För raster-PNG: npm run shots:v12workspace:insights (kräver chromium).
 * Kör: node ./scripts/gen-v12-workspace-insights-preview.mjs
 */
...
// Aktiva automation-signaler driver både Smart Next Step (top-signal) och
// Insights-listan. Riktig data-form (ruleId/status/risk/what/why) — ingen fejk.
const automationSignals = [
  {
    ruleId: 'consent-missing',
    status: 'active',
    risk: 'block',
    what: 'Samtycke saknas inför behandling',
    why: 'Kunden har inte signerat samtycke för PRP-hår — måste lösas innan start.',
  },
  {
    ruleId: 'followup-due',
    status: 'active',
    risk: 'review',
    what: 'Uppföljning rekommenderas',
    why: '8 veckor sedan senaste behandling — boka kontroll.',
  },
  {
    ruleId: 'rebook-opportunity',
    status: 'active',
    risk: '',
    what: 'Möjlighet till ombokning',
    why: 'Kunden visade intresse för Botox vid senaste besök.',
  },
];
...
const page =
  ...
  '<title>V12 Customer Workspace · Insikter & nästa åtgärd — viewport-preview</title>' +
  ...
  '<h1>V12 Customer Workspace · Block 6 — Insikter & nästa åtgärd (sektion 12)</h1>' +
  '<p>Browserlös render bakom <code>?v12workspace=on</code>. Återanvänder V11-adaptrarna ' +
  'buildSmartNextStep + buildInsightsFromSignals och befintliga CTA-attribut ' +
  '(<code>data-kk-sig</code> / <code>data-kk-sig-label</code> / <code>data-kk-patient-id</code>). ' +
  'Inga aktiva signaler → explicit empty-state. ' +
  'Raster-PNG: <code>npm run shots:v12workspace:insights</code>.</p>' +
  '<div class="row">' +
  frames +
  '</div></body></html>';

const outDir = join(root, 'docs/handover/MOCKUPS/v12-workspace-insights');

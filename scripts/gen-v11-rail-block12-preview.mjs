/**
 * V11-RAIL Fas 3 · Block 12 — … + J Journals (KEEP) viewport-preview (browserlös).
 ...
 * mappning och J:s journallista (sortering/state/snippet) körs på riktigt.
 *
 * För raster-PNG: npm run shots:v11rail:block12 (kräver chromium).
 * Kör: node ./scripts/gen-v11-rail-block12-preview.mjs
 */
...
const journalEntries = [
  {
    ...
    summary: 'Tredje PRP-sessionen. Patienten tolererade behandlingen väl, inga komplikationer.',
    authorName: 'Dr. Lind',
  ...
  },
  {
    title: 'Konsultation',
    journalType: 'consult',
    note: 'Genomgång av behandlingsplan och förväntningar. Foto taget för baslinje.',
    authorName: 'Fazli',
    signedAt: '2026-04-02T14:00:00Z',
    locked: true,
  },
  {
...
const page =
  ...
  '<title>V11 Rail · Block 12 · J Journals (KEEP) — viewport-preview</title>' +
  ...
  '<h1>V11 Rail · Fas 3 · Block 12 — J Journals (KEEP)</h1>' +
  '<p>Riktiga komponenterna i tre iframes (ordning D → A → V → B → C → E → F → G → H → I → J → S). J = ' +
  'journalposter ovanpå befintlig journal-logik: senaste först (signed/draft), varje rad bär ' +
  'data-v9-section-link=&quot;journal&quot; (öppnar journal-fliken) — befintlig handler, ingen ny. ' +
  'Raster-PNG: <code>npm run shots:v11rail:block12</code>.</p>' +
  '<div class="row">' +
  frames +
  '</div></body></html>';

const outDir = join(root, 'docs/handover/MOCKUPS/v11-rail-block12-J-journals');

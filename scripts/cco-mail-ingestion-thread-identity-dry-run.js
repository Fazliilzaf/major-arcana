...
async function main() {
  ...
  if (!filePath) {
    console.error('Använd: node scripts/cco-mail-ingestion-thread-identity-dry-run.js --store /sökväg/till/cco-mail-ingestion.json');
    process.exit(1);
  }
  ...
  console.log(JSON.stringify({
    ...
    sampleThreads: Object.values(threadIdentityIndex).slice(0, 5).map((e) => ({

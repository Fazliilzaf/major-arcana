/**
 * V12 Customer Workspace · Block 11 — browserlös render av Bilder / före–efter-
 * modulen i två-zon-shellen i tre iframes (390 / 820 / 1440).
 *
 * För raster-PNG: npm run shots:v12workspace:photos (kräver chromium).
 * Kör: node ./scripts/gen-v12-workspace-photos-preview.mjs
 */
...
const driveFiles = [
  { id: 'img-1', originalFileName: 'fore_hjassa.jpg', fileType: 'image' },
  { id: 'img-2', originalFileName: 'efter_hjassa.jpg', fileType: 'image' },
  { id: 'img-3', originalFileName: 'oversikt.png', fileType: 'image' },
  { id: 'vid-1', originalFileName: 'behandling.mp4', fileType: 'video' },
];
...
const page =
  ...
  '<title>V12 Customer Workspace · Bilder — viewport-preview</title>' +
  ...
  '<h1>V12 Customer Workspace · Block 11 — Bilder / före–efter (sektion 7)</h1>' +
  '<p>Browserlös render bakom <code>?v12workspace=on</code>. Återanvänder V11-adaptern ' +
  'buildPhotosFromDriveFiles + native länkar med <code>data-photo</code> (befintlig lightbox, ' +
  'ingen ny handler). Utan backend visas fallback-tiles. Före/efter-etikett + datum saknas i ' +
  'källan → jämförelsevy uppskjuten. Tom lista → explicit empty-state. ' +
  'Raster-PNG: <code>npm run shots:v12workspace:photos</code>.</p>' +
  '<div class="row">' +
  frames +
  '</div></body></html>';

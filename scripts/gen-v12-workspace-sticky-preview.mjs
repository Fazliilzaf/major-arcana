/**
 * V12 Customer Workspace · Block 9 — browserlös render av Sticky arbetsbar-modulen
 * i två-zon-shellen i tre iframes (390 / 820 / 1440).
 *
 * För raster-PNG: npm run shots:v12workspace:sticky (kräver chromium).
 * Kör: node ./scripts/gen-v12-workspace-sticky-preview.mjs
 */
...
const bcard = {
  ...
  lifetimeValue: 48000,
  upcomingBookings: [
    { start: '2026-07-01T10:00:00Z', title: 'PRP-hår', staff: 'Dr. Lind' },
    { start: '2026-08-12T14:30:00Z', title: 'Uppföljning', staff: 'Dr. Lind' },
  ],
};
...
const page =
  ...
  '<title>V12 Customer Workspace · Sticky arbetsbar — viewport-preview</title>' +
  ...
  '<h1>V12 Customer Workspace · Block 9 — Sticky arbetsbar (sektion 13)</h1>' +
  '<p>Browserlös render bakom <code>?v12workspace=on</code>. Återanvänder V11-adaptern ' +
  'buildStickyActions + befintliga handlers: "Boka nästa" (<code>data-kk-ord48-open-calendar</code>, ' +
  'disabled tills redo) och "Bekräfta kommande tider (N)" (<code>data-v9-quick="confirm"</code>). ' +
  'Ingen ny handler. N/ready från riktig data; inga kommande tider → disabled. ' +
  'Raster-PNG: <code>npm run shots:v12workspace:sticky</code>.</p>' +
  '<div class="row">' +
  frames +
  '</div></body></html>';

const outDir = join(root, 'docs/handover/MOCKUPS/v12-workspace-sticky');

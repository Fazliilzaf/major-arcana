/**
 * V11-RAIL Fas 3 · Block 4 — A + V + B + C viewport-preview (browserlös).
 ...
 *
 * För raster-PNG: npm run shots:v11rail:block4 (kräver chromium).
 * Kör: node ./scripts/gen-v11-rail-block4-preview.mjs
 */
...
const page =
  ...
  '<title>V11 Rail · Block 4 · A + V + B + C — viewport-preview</title>' +
  ...
  '<h1>V11 Rail · Fas 3 · Block 4 — A Profile + V Active Visit + B Smart info + C Stats</h1>' +
  '<p>Riktiga komponenterna i tre iframes (ordning A → V → B → C, aktivt besök in_progress). ' +
  'Varje iframe har egen viewport så @media (canon §4) resolvar per bredd. ' +
  'Raster-PNG: <code>npm run shots:v11rail:block4</code> i miljö med browser.</p>' +
  '<div class="row">' +
  frames +
  '</div></body></html>';

const outDir = join(root, 'docs/handover/MOCKUPS/v11-rail-block4-V-active-visit');

/**
 * V12 Customer Workspace · Block 4 — browserlös render av Bokningar-modulen
 * (kommande + historik) i två-zon-shellen i tre iframes (390 / 820 / 1440).
 *
 * För raster-PNG: npm run shots:v12workspace:bookings (kräver chromium).
 * Kör: node ./scripts/gen-v12-workspace-bookings-preview.mjs
 */
...
const page =
  ...
  '<title>V12 Customer Workspace · Bokningar — viewport-preview</title>' +
  ...
  '<h1>V12 Customer Workspace · Block 4 — Bokningar (sektion 8): kommande + historik</h1>' +
  '<p>Browserlös render bakom <code>?v12workspace=on</code>. Återanvänder V11-adaptrarna ' +
  'buildBookingsFromExtras/buildHistoryFromExtras + befintlig confirm-handler ' +
  '(<code>data-v9-quick="confirm"</code>). Raster-PNG: <code>npm run shots:v12workspace:bookings</code>.</p>' +
  '<div class="row">' +
  frames +
  '</div></body></html>';

const outDir = join(root, 'docs/handover/MOCKUPS/v12-workspace-bookings');

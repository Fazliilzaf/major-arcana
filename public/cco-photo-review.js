...
(() => {
      ...
      <div class="cco-photo-review-focus">
        ...
        <div class="cco-photo-review-focus-meta">
          ...
          <p class="cco-photo-review-muted cco-photo-review-shortcuts">
            1/2/3 godkänn · R avvisa · C omkategori · N/P eller pilar navigera
          </p>
        </div>
      </div>`;
  ...
  function bindKeyboard() {
    document.addEventListener('keydown', (ev) => {
      ...
      if (busy) return;
      if (ev.key === '1') void decide('approve', 'photo_before');
      else if (ev.key === '2') void decide('approve', 'photo_during');
      else if (ev.key === '3') void decide('approve', 'photo_after');
      else if (ev.key === 'r' || ev.key === 'R') void decide('reject');
      else if (ev.key === 'c' || ev.key === 'C') void decide('reassign');
    ...
    root.innerHTML = `
      <header class="cco-photo-review-header">
        <div class="cco-photo-review-header-row">
          ...
          <span class="cco-photo-review-badge cco-photo-review-badge-write">Fas 2 — Full manuell review</span>
        </div>
        <p class="cco-photo-review-muted">861 bilder · 150 patienter · ett beslut i taget · ingen massapproval</p>
